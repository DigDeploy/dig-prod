<template>
  ...
  >
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <el-form-item label="所属" prop="belonging">
                  <el-input v-model="form.belonging" placeholder="" show-word-limit maxlength="50" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <el-form-item label="出張先1" prop="businessTrip">
                  <el-input v-model="form.businessTrip" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="出張先2" prop="businessTrip2">
                  <el-input v-model="form.businessTrip2" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="出張先3" prop="businessTrip3">
                  <el-input v-model="form.businessTrip3" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <el-form-item label="所在地1" prop="location">
                  <el-input v-model="form.location" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="所在地2" prop="location2">
                  <el-input v-model="form.location2" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="所在地3" prop="location3">
                  <el-input v-model="form.location3" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
              <el-col :span="8">
                <el-form-item label="要件1" prop="requirements">
                  <el-input v-model="form.requirements" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="要件2" prop="requirements2">
                  <el-input v-model="form.requirements2" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="要件3" prop="requirements3">
                  <el-input v-model="form.requirements3" placeholder="" show-word-limit maxlength="100" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10">
              ...
              <el-col :span="8">
                <el-form-item label="承認者" prop="approveId">
                  <el-input v-model="form.approveId" placeholder="" show-word-limit maxlength="20" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="10" style="margin-right: 1px;">
              <el-col :span="8">
                <el-form-item label="指示者" prop="indicateId">
                  <el-input v-model="form.indicateId" placeholder="" show-word-limit maxlength="20" />
                </el-form-item>
              </el-col>
                  ...
                  <el-col :span="5" style="padding: 0 !important; float: right">
                    <div style="border: 1px solid #dcdfe6; border-left: none">
                      ...
                      <el-button
                        ...
                        >{{ initialApproveManager ? '課長承認済' : (form.approveManager && form.managerApproveDate ? '課長承認取消' : '課長承認') }}
                      </el-button>
                    </div>
                  </el-col>
                  <el-col :span="5" style="padding: 0 !important; float: right">
                    <div style="border: 1px solid #dcdfe6; border-left: none">
                      ...
                      <el-button
                        ...
                        >{{ initialApproveDirector ? '部長承認済' : (form.approveDirector && form.directorApproveDate ? '部長承認取消' : '部長承認') }}
                      </el-button>
                    </div>
                  </el-col>
                  <el-col :span="5" style="padding: 0 !important; float: right">
                    <div style="border: 1px solid #dcdfe6; border-left: none">
                      ...
                      <el-button
                        ...
                        >{{ initialApprovePresident ? '社長承認済' : (form.approvePresident && form.presidentApproveDate ? '社長承認取消' : '社長承認') }}
                      </el-button>
                    </div>
                  </el-col>
                    ...
                    <div style="border: 1px solid #dcdfe6; border-left: none">
                      ...
                      <el-button
                        ...
                        style="
                          ...
                          width: 100%;
                        "
                        :disabled="approveManagerDisabled || initialReportApproveManager"
                        >{{ initialReportApproveManager ? '課長承認済' : (form.reportApproveManager && form.reportManagerApproveDate ? '課長承認取消' : '課長承認') }}
                      </el-button>
                    </div>
                  </el-col>
                  <el-col :span="5" style="padding: 0 !important; float: right">
                    <div style="border: 1px solid #dcdfe6; border-left: none">
                      ...
                      <el-button
                        ...
                        style="
                          ...
                          width: 100%;
                        "
                        :disabled="approveDirectorDisabled || initialReportApproveDirector"
                        >{{ initialReportApproveDirector ? '部長承認済' : (form.reportApproveDirector && form.reportDirectorApproveDate ? '部長承認取消' : '部長承認') }}
                      </el-button>
                    </div>
                  </el-col>
                  <el-col :span="5" style="padding: 0 !important; float: right">
                    <div style="border: 1px solid #dcdfe6; border-left: none">
                      ...
                      <el-button
                        ...
                        style="
                          ...
                          width: 100%;
                        "
                        :disabled="approvePresidentDisabled || initialReportApprovePresident"
                        >{{ initialReportApprovePresident ? '社長承認済' : (form.reportApprovePresident && form.reportPresidentApproveDate ? '社長承認取消' : '社長承認') }}
                      </el-button>
                    </div>
                  </el-col>
                  <el-col :span="4" style="padding: 0 !important; float: right">
          ...
          <el-row :gutter="10" type="flex" align="middle">
            <el-col :span="24" style="display: flex">
              ...
              <el-button type="primary" @click="handlePrint('travelFeePrint')"
                :disabled="form.isBusTravelFee === '0'"
                >出張精算書印刷
              </el-button>
            </el-col>
          </el-row>
    ...
    <div class="footer-back">
      ...
      <el-button type="primary" @click="handlePrint('instructionPrint')"
        >印刷</el-button>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      initialReportApproveManager: false,
      initialReportApproveDirector: false,
      initialReportApprovePresident: false,
      isBusTravelFee: "0",
      subNumber: "",
      negotiationNo: "",
      getInfoFlag: false,
  ...
  async created() {
    ...
    const instructionNo = this.$route.params && this.$route.params.instructionNo;
    if (instructionNo) {
      await this.getInfo(instructionNo);
    }
    await this.getUser();
  ...
  methods: {
    ...
    // 情報取得
    async getInfo(instructionNo) {
      await getInstruction(instructionNo)
        .then((response) => {
          this.form = response.data;
          this.hasUnsavedChanges = false;

          this.form.expenses = String(this.form.expenses);
          ...
          this.initialReportApproveManager = !!(this.form.reportApproveManager && this.form.reportManagerApproveDate);
          this.initialReportApproveDirector = !!(this.form.reportApproveDirector && this.form.reportDirectorApproveDate);
          this.initialReportApprovePresident = !!(this.form.reportApprovePresident && this.form.reportPresidentApproveDate);

          (this.roleList = response.data.roleList), this.roleDisabled(response);
        })
    ...
    openTravelFee() {
      let travelFee = {
        instructionNo: this.form.instructionNo,
        operation: "edit",
        getInfoFlag: this.getInfoFlag,
        isBusTravelFee: this.isBusTravelFee,
        roleList: this.roleList,
      };

      if(this.isBusTravelFee === '0'){
        ...
        travelFee.belonging = this.form.belonging,
        travelFee.loginName= loginName,
        travelFee.businessTrip= this.form.businessTrip,
        travelFee.location= this.form.location,
        travelFee.requirements= this.form.requirements,
        travelFee.roleList= this.roleList,
        travelFee.travelFeeForm= this.form.travelFeeForm
   ...
   async getUser() {
    ...
    submitForm() {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          if (this.form.negotiationType + '' === '0') {
            this.form.negotiationNo = this.negotiationNo + "|" + this.subNumber;
          }
    ...
    handleClose() {
        // 遷移設定
        let obj = {path: this.fromRouterPath, query: this.fromRouterQuery};
    ...
    handleApprove(value) {
      ...
      if (value === "approvePresident") {
        if (this.initialApprovePresident) {
          return;
        }
        ...
        if (this.initialApproveDirector) {
          return;
        }
        ...
        if (this.initialReportApprovePresident) {
          return;
        }
        if (this.form.reportApprovePresident && this.form.reportPresidentApproveDate) {
        ...
        if (this.initialReportApproveDirector) {
          return;
        }
        if (this.form.reportApproveDirector && this.form.reportDirectorApproveDate) {
        ...
        if (this.initialReportApproveManager) {
          return;
        }
        if (this.form.reportApproveManager && this.form.reportManagerApproveDate) {
