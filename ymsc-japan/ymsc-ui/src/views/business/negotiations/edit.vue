  ...
  <div class="app-container-router">
    <el-form ref="form" :model="form" :rules="rules" label-width="148px">
      <el-row :gutter="10" class="mb8">
        <div style="float: left !important;">
          <el-button
            ...
            size="mini"
            v-if="form.kariFlg === '0'"
            :disabled="!form.negotiationName || commentOnlyFlag"
            @click="toInstruction"
          >出張命令書
          </el-button>
        </div>
        ...
        <el-row :gutter="10">
          <el-col :span="8">
            <el-form-item label="営業担当（主）" prop="mainResponsible">
              <el-select v-model="form.mainResponsible" filterable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label-width="168px" label="営業管理者（上司）" prop="managerResponsible">
              <el-select v-model="form.managerResponsible" placeholder="" :disabled="commentOnlyFlag">
                <el-option
        ...
        <el-row :gutter="10">
          <el-col :span="6">
            <el-form-item label="案件種類" prop="negotiationType">
              <el-select v-model="form.negotiationType" placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="子番" prop="subNumber" label-width="80px">
              <div class="input-button-grid">
                <el-input v-model="form.subNumber" disabled style="width: 80px;"/>
                <el-button style="margin-left:5px;" :disabled="revisionNumberActive || form.kariFlg =='1' || commentOnlyFlag"
                           :type="subNumberActive ? 'danger' : 'primary'" @click="getSubNumber">{{ subNumberActive ?
                  'キャンセル' : '子番取得' }}
                </el-button>
              </div>
            </el-form-item>
          ...
          <el-col :span="6">
            <el-form-item label="改定" prop="revisionNumber" label-width="80px">
              <div class="input-button-grid">
                <el-input v-model="form.revisionNumber" disabled style="width: 80px;"/>
                <el-button style="margin-left:5px" :disabled="subNumberActive || form.kariFlg =='1' || commentOnlyFlag"
                           :type="revisionNumberActive ? 'danger' : 'primary'" @click="getRevisionNumber">{{
                  revisionNumberActive ? 'キャンセル' : '改定取得' }}
                </el-button>
              </div>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="登録日" prop="registrationDate">
              <el-date-picker clearable :disabled="commentOnlyFlag"
          ...
          <el-col :span="8">
            <el-form-item label="起票者" prop="creator">
              <el-select v-model="form.creator" placeholder="" @change="updateNotificationRecipients('creator')" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="営業担当" prop="responsiblePerson">
              <el-select v-model="form.responsiblePerson" placeholder="" @change="updateNotificationRecipients('responsiblePerson')" :disabled="commentOnlyFlag">
                <el-option
                  v-for="user in userList"
                  :key="user.userId"
                  :label="user.nickName"
      ...
      <title-bar title="得意先情報" is-top>
          ...
          <el-col :span="9">
            <el-form-item label="得意先番号" prop="customerNo" label-width="180px">
              <div class="input-button-group">
                <el-input v-model="form.customerNo" class="ym-input-standard" @blur="getCustomer" :disabled="commentOnlyFlag">
                <el-button slot="append" icon="el-icon-search" @click="openCustomer" v-if="!commentOnlyFlag"/>
                </el-input>
                <el-button type="primary" size="small" @click="openCustomerAdd" v-if="!commentOnlyFlag">得意先登録</el-button>
              </div>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="得意先名" prop="customerName" label-width="180px" maxlength="6">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="得意先部門（窓口）" prop="customerWindowDept" label-width="180px">
              <el-input v-model="form.customerWindowDept" placeholder="" maxlength="50" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="窓口担当者" prop="windowContact" label-width="180px">
              <el-input v-model="form.windowContact" placeholder="" maxlength="50" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="得意先部門（依頼元）" prop="customerRequestDept" label-width="180px">
              <el-input v-model="form.customerRequestDept" placeholder="" maxlength="50" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="依頼元担当者" prop="requestContact" label-width="180px">
              <el-input v-model="form.requestContact" placeholder="" maxlength="50" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
        </el-row>
      </title-bar>
        ...
        <el-row :gutter="10">
          <el-col :span="6">
            <el-form-item label="案件区分1" prop="negotiationCat1">
              <el-select v-model="form.negotiationCat1" clearable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="案件区分2" prop="negotiationCat2">
              <el-select v-model="form.negotiationCat2" clearable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="案件区分3" prop="negotiationCat3">
              <el-select v-model="form.negotiationCat3" clearable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="案件区分4" prop="negotiationCat4">
              <el-select v-model="form.negotiationCat4" clearable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="案件区分5" prop="negotiationCat5">
              <el-select v-model="form.negotiationCat5" clearable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="案件区分6" prop="negotiationCat6">
              <el-select v-model="form.negotiationCat6" clearable placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="案件区分7" prop="negotiationCat7">
              <el-select v-model="form.negotiationCat7" placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="6">
            <el-form-item label="納入地域" prop="deliveryRegion">
              <el-select v-model="form.deliveryRegion" placeholder="" :disabled="commentOnlyFlag">
                <el-option
          ...
          <el-col :span="16">
            <el-form-item label="案件名" prop="negotiationName" label-width="180px">
              <el-input v-model="form.negotiationName" placeholder="" maxlength="100" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="業務内容" prop="businessContent" label-width="180px">
              <el-input v-model="form.businessContent" type="textarea" placeholder="" maxlength="200" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="必須要件" prop="requiredElements" label-width="180px">
              <el-input v-model="form.requiredElements" type="textarea" placeholder="" maxlength="200" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="ほか要件" prop="optionalElements" label-width="180px">
              <el-input v-model="form.optionalElements" type="textarea" placeholder="" maxlength="200" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="取引条件" prop="transactionTerms" label-width="180px">
              <el-input v-model="form.transactionTerms" type="textarea" placeholder="" maxlength="100" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="備考1" prop="remarks1" label-width="180px">
              <el-input v-model="form.remarks1" type="textarea" placeholder="" maxlength="200" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="16">
            <el-form-item label="備考2" prop="remarks2" label-width="180px">
              <el-input v-model="form.remarks2" type="textarea" placeholder="" maxlength="200" show-word-limit :disabled="commentOnlyFlag"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
      ...
      <title-bar title="活動報告" is-top>
        <el-row :gutter="10">
          <el-col :span="2">
            <el-button :disabled="commentOnlyFlag"
              type="primary"
              style="height: 40px"
              size="mini"
              @click="openActivity()"
        ...
        <el-table :data="form.activityList" border ref="dataTable">
          ...
          <el-table-column label="活動日" :header-align="alignTableConfig.header" :align="alignTableConfig.text"
            ...
            <template slot-scope="scope">
              <a v-if="!commentOnlyFlag" @click="handleEditlActivity(scope.row, scope.$index)" style="cursor: pointer; color: #409EFF;">
                {{ parseTime(scope.row.activityDate, '{y}-{m}-{d}') }}
              </a>
              <span v-else @click="handleDetailActivity(scope.row, scope.$index)" style="cursor: pointer;color: #409EFF;">
                {{ parseTime(scope.row.activityDate, '{y}-{m}-{d}') }}
              </span>
            </template>
          </el-table-column>
          ...
          <el-table-column label="操作" :header-align="alignTableConfig.header" :align="alignTableConfig.action"
            ...
            <template slot-scope="scope">
              <el-button v-if="!commentOnlyFlag"
                size="mini"
                type="text"
                icon="el-icon-edit"
                @click="handleEditlActivity(scope.row, scope.$index)"
              >編集
              </el-button>
              <el-button v-if="!commentOnlyFlag"
                size="mini"
          ...
          <el-col :span="8">
            <el-form-item label="評価登録者" prop="evaluationRegistrationUser">
              <div class="input-button-group input-button-grid">
                ...
                <el-button v-if="form.kariFlg === '0'" :type="evaluationActive ? 'danger' : 'primary'" :disabled="commentOnlyFlag"
                  @click="setEvaluation">{{ evaluationActive ? 'キャンセル' : '評価修正' }}
                </el-button>
              </div>
            </el-form-item>
          </el-col>
        ...
        <div class="flex-row">
          <div class="flex-col">
            <el-form-item label="重要度" prop="importance" label-width="98px">
              <el-select v-model="form.importance" clearable :disabled="!evaluationActive && form.kariFlg === '0' || commentOnlyFlag" placeholder="">
                <el-option
          ...
          <div class="flex-col">
            <el-form-item label="難易度" prop="difficulty" label-width="98px">
              <el-select v-model="form.difficulty" clearable :disabled="!evaluationActive && form.kariFlg === '0' || commentOnlyFlag" placeholder="">
                <el-option
          ...
          <div class="flex-col">
            <el-form-item label="物量" prop="volumeOfGoods" label-width="98px">
              <el-select v-model="form.volumeOfGoods" clearable :disabled="!evaluationActive && form.kariFlg === '0' || commentOnlyFlag" placeholder="">
                <el-option
          ...
          <div class="flex-col">
            <el-form-item label="付加価値" prop="addedValue" label-width="98px">
              <el-select v-model="form.addedValue" clearable :disabled="!evaluationActive && form.kariFlg === '0' || commentOnlyFlag" placeholder="">
                <el-option
          ...
          <div class="flex-col">
            <el-form-item label="確率" prop="probability" label-width="98px">
              <el-select v-model="form.probability" clearable :disabled="!evaluationActive && form.kariFlg === '0' || commentOnlyFlag" placeholder="">
                <el-option
    ...
    <el-dialog title="見積・受注" :visible.sync="quotationOpen" width="1300px" append-to-body
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="見積ステータス" prop="status">
                  <el-select v-model="tempQuotation.status" placeholder="" :disabled="commentOnlyFlag">
                    <el-option
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="連携用見積番号" prop="coopQuotationId">
                  <el-input v-model="tempQuotation.coopQuotationId" placeholder="" :disabled="commentOnlyFlag" maxlength="20"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="概算金額" prop="estimateAmount">
                  <el-input-number v-model="tempQuotation.estimateAmount" placeholder="" min="0" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="単位" prop="unit">
                  <el-select v-model="tempQuotation.unit" placeholder="" :disabled="commentOnlyFlag">
                    <el-option
            ...
            <el-row>
              <el-col :span="20">
                <el-form-item label="備考" prop="remark">
                  <el-input type="textarea" v-model="tempQuotation.remark" placeholder="" maxlength="100" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
            </el-row>
          </title-bar>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="受注番号" prop="orderNo">
                  <el-input v-model="tempQuotation.orderNo" placeholder="受注番号が無い場合は受注番号項目に「－」を入力してください。" maxlength="50" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="担当部門（正）" prop="orderDept">
                  <el-input v-model="tempQuotation.orderDept" placeholder="" maxlength="50" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="担当者（正）" prop="orderUser">
                  <el-input v-model="tempQuotation.orderUser" placeholder="" maxlength="25" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="担当部門（副）" prop="orderDeptSub">
                  <el-input v-model="tempQuotation.orderDeptSub" placeholder="" maxlength="50" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="担当者（副）" prop="orderUserSub">
                  <el-input v-model="tempQuotation.orderUserSub" placeholder="" maxlength="25" :disabled="commentOnlyFlag"/>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="20">
                <el-form-item label="備考" prop="orderRemark">
                  <el-input type="textarea" v-model="tempQuotation.orderRemark" placeholder="" :disabled="commentOnlyFlag"
                            maxlength="100"/>
                </el-form-item>
              </el-col>
            </el-row>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="cancelQuotation" v-if="!commentOnlyFlag">確定</el-button>
    ...
    <div class="footer-back">
      ...
      <el-button v-if="form.kariFlg === '1'" type="primary" plain @click="submitKari">仮登録</el-button>
      <el-button @click="handleClose">戻る</el-button>
    </div>
  </div>
</template>
<script>
    import {getNegotiations, updateNegotiations, addNegotiations, updateKari, getLatestSubNumber, getKaiteiNumber} from "@/api/business/negotiations";
    import {getUserProfile, listUser, selectJoshiAndDeptUser} from "@/api/system/user";
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    managerResponsible: [
                        {required: true, message: "営業管理者（上司）は必須です", trigger: "change"}
                    ],
                ...
                tempQuotation: {},
                status: '',
                subNumberActive: false,
                revisionNumberActive: false,
                originalSubNumber: '000',
                originalRevisionNumber: 0,
                evaluationActive: false,
                originalEvaluation: {
                    evaluationRegistrationUser: '',
        ...
        async created() {
            ...
            if (negotiationNo) {
                await this.getUser();
                await this.getNegotiations(negotiationNo, subNumber);
                await this.updateManagerList(this.form.mainResponsible);
            }
            this.setCommentOnlyFlag();
        ...
        methods: {
            setCommentOnlyFlag() {
              if (this.form.kariFlg + '' === '1') {
                // 仮登録の場合
                this.commentOnlyFlag = false;
              } else {
                // 仮登録以外の場合
                let loginId = String(this.$store.getters.userId);
                if (this.form.mainResponsible + '' !== loginId && this.form.managerResponsible + '' !== loginId) {
                  this.commentOnlyFlag = true;
                } else {
                  this.commentOnlyFlag = false;
                }
              }
            ...
            async getNegotiations(negotiationNo, subNumber) {
            ...
            getSubNumber() {
                if (!this.subNumberActive) {
                    this.originalSubNumber = this.form.subNumber;
                    this.$modal.loading();
                    getLatestSubNumber(this.form.negotiationNo).then(response => {
                        let latestSubNumber = response.data;
                        let current = parseInt(latestSubNumber) + 1;
                        this.form.subNumber = current.toString().padStart(3, '0');
                        this.subNumberActive = true;
                    }).catch((err) => {
                        console.log(err);
                        this.$modal.msgError("子番取得に失敗しました。");
                    }).finally(() => {
                        this.$modal.closeLoading();
                    });

                } else {
                    this.form.subNumber = this.originalSubNumber;
                    this.subNumberActive = false;
                }
            },
           getRevisionNumber() {
                if (!this.revisionNumberActive) {
                    this.originalRevisionNumber = this.form.revisionNumber;
                    getKaiteiNumber(this.form.revisionNumber).then(response => {
                      if(response.data === 'warning'){
                        this.form.revisionNumber = this.originalRevisionNumber;
                        this.$modal.msgWarning(
                          "改定番号を取得できません。"
                        );
                        return;
                      }
                      this.form.revisionNumber = response.data;
                      this.revisionNumberActive = true;
                    }).catch((err) => {
                        console.log(err);
                        this.revisionNumberActive = true;
                    });
                    ...
                    this.form.revisionNumber = this.originalRevisionNumber;
                    this.revisionNumberActive = false;
                }
            },
            ...
            setEvaluation() {
                if (!this.evaluationActive) {
                    this.originalEvaluation = {
                        evaluationRegistrationUser: this.form.evaluationRegistrationUser,
                        evaluationRegistrationDate: this.form.evaluationRegistrationDate,
                        importance: this.form.importance,
                        difficulty: this.form.difficulty,
                        volumeOfGoods: this.form.volumeOfGoods,
                        addedValue: this.form.addedValue,
                        probability: this.form.probability
                    };
                    this.form.evaluationRegistrationUser = this.$store.getters.nickName;
                    this.form.evaluationRegistrationDate = new Date();
                    this.evaluationActive = true;
                } else {
                    this.form.evaluationRegistrationUser = this.originalEvaluation.evaluationRegistrationUser;
                    this.form.evaluationRegistrationDate = this.originalEvaluation.evaluationRegistrationDate;
                    this.form.importance = this.originalEvaluation.importance;
                    this.form.difficulty = this.originalEvaluation.difficulty;
                    this.form.volumeOfGoods = this.originalEvaluation.volumeOfGoods;
                    this.form.addedValue = this.originalEvaluation.addedValue;
                    this.form.probability = this.originalEvaluation.probability;
            ...
            async updateManagerList(userId) {
                ...
                await allocatedUserList(vo).then(response => {
                    ...
                    if (this.managerList.length > 0) {
                      let checkUser = this.managerList.find(x => x.userId + '' === this.form.managerResponsible + '');
                      if (!checkUser) {
                        this.form.managerResponsible = this.managerList[0].userId;
                      }
                    } else {
                      this.form.managerResponsible = null;
                    }
            ...
            // 戻る・閉じる
            handleClose() {
                if (this.$route.params.route === 'index') {
                    const router = "/newCase/negotiations";
                    this.$router.push(router);
                }
                if (this.$route.params.route === 'home') {
                    const tab = this.$route.query.tab || 'newNotice';
                ...
                if (this.$route.params.route === 'add') {
                    const router = "/newCase/negotiationsAdd/index";
                    this.$router.push(router);
                }
            },
                ...
                this.$refs["form"].validate(valid => {
                    if (valid) {
                        ...
                        if (this.subNumberActive) {
                            ...
                            updateNegotiations(this.form).then(response => {
                              if (this.form.kariFlg === '1') {
            ...
            submitKari() {
                this.$modal.loading();
                updateKari(this.form).then(response => {
                    this.$modal.msgSuccess("仮登録しました。");
                    this.hasUnsavedChanges = false;
                    this.handleClose();
                }).catch((err) => console.log(err))
                    .finally(() => this.$modal.closeLoading());
            ...
            updateNotificationRecipients(field) {
                const recipients = new Set();
                if (this.form.notificationRecipient) {
                    const originRecipients = Array.isArray(this.form.notificationRecipient)
                        ? this.form.notificationRecipient
                        : this.form.notificationRecipient.split(',');
                ...
                // 只添加当前修改的字段
                if (field === 'creator' && this.form.creator) {
                    const cleanId = String(this.form.creator).trim();
                    if (cleanId) recipients.add(cleanId);
                } else if (field === 'responsiblePerson' && this.form.responsiblePerson) {
                    const cleanId = String(this.form.responsiblePerson).trim();
                    if (cleanId) recipients.add(cleanId);
                }

                this.form.notificationRecipient = Array.from(recipients).join(',');
            },
            toInstruction() {
                if (this.form.activityList.length > 0) {
                    const router = "/instruction/InstructionAddHome/home/" + this.form.negotiationNo + "/" + this.form.subNumber + "/1" + "/" +this.$route.params.route;
                    this.$router.push(router);
                } else {
                    const router = "/instruction/InstructionAddHome/home/" + this.form.negotiationNo + "/" + this.form.subNumber + "/-1" + "/" + this.$route.params.route;
                    this.$router.push(router);
