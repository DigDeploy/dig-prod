      ...
      <el-row :gutter="10">
        <el-col :span="12">
          <el-form-item label="テンプレートコード" prop="templateCode">
            <el-input v-model="form.templateCode" maxlength="50" placeholder=""/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
<script>
import {addTemplate} from "@/api/system/template";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          addTemplate(this.form).then(response => {
            this.$modal.closeLoading();
            this.$modal.msgSuccess(this.$YmMessage.getMessage("IN00001"));
            this.handleClose();
