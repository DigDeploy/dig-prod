...
// 参照https://github.com/vuejs/vue/blob/v2.6.10/src/platforms/web/server/util.js
...
const componentChild = {
  ...
  'el-upload': {
    'list-type': (h, conf, key) => {
      ...
      if (conf.showTip) {
        list.push(<div slot="tip" class="el-upload__tip">{conf.fileSize}{conf.sizeUnit}以下の{conf.accept}ファイルのみアップロード可能です</div>)
      }
      return list
    }
  }
